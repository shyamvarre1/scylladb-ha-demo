...
Two behaviors worth calling out, both verified against a real two-datacenter ScyllaDB cluster driven by the Python driver — see [`verify/`](verify/) to reproduce:
